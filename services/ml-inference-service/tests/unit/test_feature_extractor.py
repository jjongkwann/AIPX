...
class TestFeatureExtractor:
    ...
    def test_extract_price_features_shape(self, sample_market_data):
        ...
        for window_size in [30, 60, 90]:
            features = extractor.extract_price_features(sample_market_data, window_size=window_size)
    ...
    def test_prepare_batch_lstm_input(self, sample_batch_market_data):
        ...
        extractor = FeatureExtractor()
        batch_features = extractor.prepare_batch_lstm_input(sample_batch_market_data, window_size=60)
