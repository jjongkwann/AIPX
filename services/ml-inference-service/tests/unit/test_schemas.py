...
class TestPredictPriceRequest:
    ...
    def test_valid_request(self):
        ...
        data = {"symbol": "005930", "ohlcv_data": [[1.0, 1.1, 0.9, 1.05, 1000000.0]] * 60}
    ...
    def test_with_model_version(self):
        ...
        data = {"symbol": "005930", "ohlcv_data": [[1.0, 1.1, 0.9, 1.05, 1000000.0]] * 60, "model_version": "2"}
    ...
    def test_missing_symbol(self):
        ...
        data = {"ohlcv_data": [[1.0, 1.1, 0.9, 1.05, 1000000.0]] * 60}
...
class TestSentimentRequest:
    ...
    def test_valid_request(self):
        ...
        data = {"text": "Samsung reports strong earnings"}
