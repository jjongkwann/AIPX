...
class TestLSTMPredictor:
    ...
    def test_model_initialization_custom(self):
        ...
        model = LSTMPredictor(input_size=10, hidden_size=256, num_layers=3, dropout=0.3, bidirectional=True)
...
class TestEnsembleCombiner:
    ...
    def test_ensemble_forward(self):
        ...
        with torch.no_grad():
            final_pred, price_comp, sent_comp, confidence = model(price_pred, sentiment, sentiment_conf)
...
class TestModelFactory:
    ...
    def test_create_basic_lstm(self):
        ...
        config = {"type": "basic", "input_size": 5, "hidden_size": 128, "num_layers": 2}
    ...
    def test_create_advanced_lstm(self):
        ...
        config = {"type": "advanced", "input_size": 5, "hidden_size": 256, "num_layers": 3}
