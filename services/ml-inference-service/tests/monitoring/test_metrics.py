...
from src.monitoring.metrics import InferenceMetrics, MetricsCollector, ModelMonitor
...
class TestMetricsCollector:
    ...
    async def test_record_successful_inference(self):
        ...
        await collector.record_inference(model_name="test_model", inference_time_ms=12.5, success=True)
    ...
    async def test_record_failed_inference(self):
        ...
        await collector.record_inference(model_name="test_model", inference_time_ms=0.0, success=False)
    ...
    async def test_record_multiple_inferences(self):
        ...
        for i in range(10):
            await collector.record_inference(model_name="test_model", inference_time_ms=10.0 + i, success=True)
    ...
    async def test_inference_times_limit(self):
        ...
        for i in range(10):
            await collector.record_inference(model_name="test_model", inference_time_ms=float(i), success=True)
    ...
    async def test_concurrent_recording(self):
        ...
        tasks = [collector.record_inference("test_model", 10.0, True) for _ in range(100)]
...
class TestModelMonitor:
    ...
    def test_monitor_initialization(self):
        ...
        monitor = ModelMonitor(alert_threshold_ms=1000.0, error_rate_threshold=0.05)
    ...
    def test_check_health_no_issues(self):
        ...
        metrics = {
            "models": {
                "test_model": {"avg_inference_time_ms": 10.0, "p99_inference_time_ms": 20.0, "success_rate": 0.99}
            }
        }
    ...
    def test_check_health_high_latency(self):
        ...
        metrics = {
            "models": {
                "test_model": {"avg_inference_time_ms": 15.0, "p99_inference_time_ms": 25.0, "success_rate": 0.99}
            }
        }
    ...
    def test_check_health_multiple_models(self):
        ...
        metrics = {
            "models": {
                "model_a": {"avg_inference_time_ms": 5.0, "p99_inference_time_ms": 8.0, "success_rate": 0.99},
                "model_b": {
    ...
    def test_alert_accumulation(self):
        ...
        metrics = {
            "models": {
                "test_model": {"avg_inference_time_ms": 15.0, "p99_inference_time_ms": 20.0, "success_rate": 0.99}
            }
        }
...
class TestMetricsIntegration:
    ...
    async def test_end_to_end_metrics(self):
        ...
        for i in range(100):
            await collector.record_inference(model_name="test_model", inference_time_ms=10.0 + i * 0.1, success=True)
